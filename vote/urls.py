...
urlpatterns = [
    ...
    path("manager/<int:manager_id>/campaigns/", views.campaign_list, name="campaign_list"),
    ...
    path("campaigns/<int:campaign_id>/elections/create/", views.create_election, name="create_election"),
